            ...
            <div className="max-w-screen-2xl mx-auto flex justify-between items-center">
                ...
                <nav className="hidden lg:flex items-center space-x-6 text-black text-base font-medium uppercase">
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute left-0 -mt-0 w-48 px-2 py-2 bg-white text-black rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300 group-hover:flex flex-col" onMouseEnter={() => setServicesOpen(true)} onMouseLeave={() => setServicesOpen(false)}>
                    ...
                    <div className="relative group">
                        ...
                        <div className="absolute left-0 -mt-0 w-48 px-2 py-2 bg-white text-black rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition duration-300 group-hover:flex flex-col" onMouseEnter={() => setMediaOpen(true)} onMouseLeave={() => setMediaOpen(false)}>
                            <Link href="/media/gallery" className="block px-4 py-2 hover:bg-gray-200 hover:rounded-xl text-sm">Gallery</Link>
                            <Link href="/media/videos" className="block px-4 py-2 hover:bg-gray-200 hover:rounded-xl text-sm">Videos</Link>
                            <Link href="/media/press" className="block px-4 py-2 hover:bg-gray-200 hover:rounded-xl text-sm">Press Releases</Link>
                        </div>
                    </div>
